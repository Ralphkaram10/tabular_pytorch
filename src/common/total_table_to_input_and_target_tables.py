...
def transform_total_table_to_input_and_target_tables(total_table_path="data/auction+verification/data.csv",input_columns=None,output_columns=None,X_filename="inputs.csv",y_filename="targets.csv",X_dir_path='data/auction+verification/inputs',y_dir_path='data/auction+verification/targets',output_csv_sep=';'):
...
def main():
    ...
    input_columns=['process.b1.capacity', 'process.b2.capacity', 'process.b3.capacity','process.b4.capacity', 'property.price', 'property.product','property.winner']

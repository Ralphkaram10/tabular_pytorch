...
def load_train_val_test_data(config):
    ...
    train_dataset = CustomDataset(
        {"table_path": config["train_table_path"], "phase": "train"}
    )
    val_dataset = CustomDataset(
        {"table_path": config["val_table_path"], "phase": "val"}
    )
    ...
    val_loader = DataLoader(
        val_dataset, batch_size=config["batch_size"], shuffle=config["shuffle"]
    )

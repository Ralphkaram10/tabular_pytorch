...
class CustomDataset(Dataset):
    ...
    def __init__(self, custom_dataset_input_dict):
        ...
        if custom_dataset_input_dict["phase"] == "train":
            self.dump_pickle()
        if custom_dataset_input_dict["phase"] == "val" or custom_dataset_input_dict["phase"] == "test":
            self.load_pickle()
    ...
    def __getitem__(self, idx):
        ...
        if self.custom_dataset_input_dict.get("phase")=='train' or self.custom_dataset_input_dict.get("phase")=='val':
...
if __name__ == '__main__':
    custom_dataset_input_dict={"table_path":"data/auction+verification/data.csv","phase":"predict"}
